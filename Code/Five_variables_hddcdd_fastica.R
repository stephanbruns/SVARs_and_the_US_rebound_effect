...
ppath<-"~/Dropbox (SSSUP)/DP16/ARC Rebound - US Data/Post-JEEM Revision/__Re-submission to Energy Econ/Replication package/" #change this
...
#----------------------------------
# 5 variables VAR with e, y, p, i, q + 2 exogenous variables: hdd + cdd
#----------------------------------
D <- dat[,c("e","y","p","i","q")]
...
round(iden$B,2) #Mixing matrix of fastICA (confidence intervals are calculated below in the rebound function)
...
#save data
res <- list("uniB.fastica_M.v5.hddcdd.p3.levels", iden, boots)
save(res, file=paste(savepath, "irf.fastica_M.v5.hddcdd.p3.levels.iter1000.RDATA", sep=""))
...
filename <- "irf.fastica_M.v5.hddcdd.p3.levels.iter1000.RDATA"
